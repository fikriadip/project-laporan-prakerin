...
<div class="panel-header bg-primary-gradient">
    <div class="page-inner py-5">
        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
            <div>
                <h2 class="text-white pb-2 fw-bold"><i class="icon-notebook mr-2"></i> Deskripsi About Landing Page
                </h2>
                <br>
            </div>
        </div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title font-weight-bold">Data Deskripsi About
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="tableDeskAbout" class="display table table-striped table-hover bg-light">
                            <thead>
                        ...
                        <div class="card-body mt-2">
                            <div class="modal-content">
                                <form action="{{ route('add.desk.about') }}" method="POST" id="add-desk-about">
                                    ...
                                    <div class="mb-3">
                                        <label for="deskripsi" class="form-label h6 font-weight-bold">Masukkan
                                            Deskripsi</label>
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">
                        ...
                        <div class="card-body mt-2">
                            <div class="modal-content">
                                <form action="{{ route('update.desk.about') }}" method="POST" id="update-desk-about">
                                    ...
                                    <div class="mb-3">
                                        <label for="deskripsi" class="form-label h6 font-weight-bold">Edit
                                            Deskripsi</label>
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">
