            ...
            <div class="card-header">
                <h4 class="card-title font-weight-bold">DataTable Home
                    <button type="button" data-toggle="modal" data-target="#ModalHome"
                        class="btn btn-primary float-right text-white"><i class="fas fa-book mr-2"></i> Tambah
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title text-primary font-weight-bold" id="exampleModalLabel">Tambah Management Home</h4>
