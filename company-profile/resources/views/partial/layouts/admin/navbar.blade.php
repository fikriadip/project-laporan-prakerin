                ...
                <ul class="dropdown-menu dropdown-user animated fadeIn">
                    <div class="dropdown-user-scroll scrollbar-outer">
                            ...
                            <div class="user-box">
                                <div class="avatar-lg">
                                    ...
                                    <img src="{{ "data:image/" . Auth::user()->imageType . ";base64," . Auth::user()->foto }}"
                                        alt="Avatar User" class="avatar-img rounded">
                                    @endif
                                </div>
                                <div class="u-text">
                        ...
                        <li>
                            ...
                            <form id="logoutRedirect" action="{{ route('logout') }}" method="GET">
                                <a class="dropdown-item" href="#" id="logoutShow">Logout</a>
                            </form>
                        </li>
                    </div>
                </ul>
