        ...
        <div class="row g-0" data-aos="fade-left">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item" data-aos="zoom-in" data-aos-delay="100">
              <a href="{{asset('landing_page/assets/img/gallery/gallery-1.jpg')}}" class="gallery-lightbox">
                <img src="{{asset('landing_page/assets/img/gallery/gallery-1.jpg')}}" alt="" class="img-fluid">
              </a>
            </div>
          </div>
        ...
        <div class="row" data-aos="fade-left">          
          ...
          <div class="col-lg-3 col-md-6 mt-4 mt-md-0">
            <div class="box featured" data-aos="zoom-in" data-aos-delay="200">
              ...
              <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Modi rerum non ex dolorum, soluta sint assumenda enim pariatur quibusdam! Vero commodi est aspernatur, nemo doloribus nisi accusantium quasi praesentium quisquam!</p>
              {{-- <ul>
                <li>Aida dere</li>
